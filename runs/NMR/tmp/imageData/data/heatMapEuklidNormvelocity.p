...
set output './tmp/imageData/_EuklidNorm(velocity)iT0000000.jpeg'
} else {set terminal png size 1920,1080font ",25"
set output './tmp/imageData/_EuklidNorm(velocity)iT0000000.png'
}set pm3d map
unset key
set size ratio -1
set size 0.925,1.0
...
set cblabel offset 0.5 "EuklidNorm(velocity)"
set autoscale fix
set palette defined ( 0 "blue", 1 "green", 2 "yellow", 3 "orange", 4 "red" )
splot './tmp/imageData/data/EuklidNorm(velocity).matrix' u ($1*0.246667+-1.42109e-14):($2*0.246667+147):3 matrix with pm3d
